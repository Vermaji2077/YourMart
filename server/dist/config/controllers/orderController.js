...
export const getUserOrders = async (req, res) => {
    try {
        ...
        return res.status(500).json({
            message: error.message ?? "Could not get orders",
        });
    }
};
// ======================================================
...
export const updateOrderStatus = async (req, res) => {
    try {
        ...
        if (status === "Delivered") {
            return res.status(400).json({
                message: "OTP verification is required before marking the order as delivered",
            });
        }
        // ----------------------------------------------
        // Status history
...
export const verifyDeliveryOtp = async (req, res) => {
    try {
        ...
        if (!order.deliveryOtp) {
            return res.status(400).json({
                message: "No delivery OTP has been generated for this order",
            });
        }
