...
export const getAdminStats = async (req, res) => {
    const [totalOrders, totalUsers, totalProducts, outOfStock, totalPartners] = await Promise.all([
...
export const getDeliveryPartners = async (req, res) => {
    const partners = await prisma.deliveryPartner.findMany({ orderBy: { name: "desc" } });
    res.json(partners);
};
