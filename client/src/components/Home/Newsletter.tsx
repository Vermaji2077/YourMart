...
const Newsletter = () => {
  return (
    <section className="bg-white py-18 px-4 sm:px-6 lg:px-8 rounded-2xl mx-auto shadow-xs mt-32 mb-20">
      <div className="max-x-2xl mx-auto text-center">
        ...
        <p className="text-app-light mb-8 text-base">
